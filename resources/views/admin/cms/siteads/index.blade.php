...
<div class="card" style="width: 100%">
    <div class="card-header">
        ...
        <a href="javascript:void(0)" type="button" class="btn btn-default btn-sm add-site-ads">add new ads</a>
        Site Ads Table 
        </h4>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <div>
                <table class="stripe" id="tbl_site_ads">
            ...
            <div class="modal-body">
                <form role="form" name="siteadsForm" id="siteadsForm" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                            ...
                            <input type="number" name="site_order" class="form-control site_order">
                        </div>
...
$(document).ready( function () {
    /* datatable */
    var site_ads_table = $('#tbl_site_ads').DataTable({
        dom: 'Bfrtip',
        LengthChange: true,
        "bProcessing": true,
        ...
        columns   : [
              ...
              {"data" :"site_order",     'name' :'site_order'},
    ...
    $('.add-site-ads').on('click',function(e){
        e.preventDefault();
        save_method = "add";
        $('.modal-title').text('Site Ads Add Form');
    ...
    $('.saveSiteAds').click(function(e){
        ...
        if(save_method == 'add')
        {
            ...
            uri = "{{ URL::to('/easy-hostel/ads/update') }}" + "/" + site_ads_id;
        }
        /* form data */
            ...
            success: function (data) {
                ...
                if(data.status=='success'){
                    ...
                    if(save_method == 'add'){
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Site Ads Added Successfully'
                        });
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Site ADs Updated successfully'
                        });
                        site_ads_table.ajax.reload();
    ...
    $("body").on('click','.site-ads-edit', function(e){
        ...
        $.ajax({
            url:"{{ URL::to('easy-hostel/ads/edit') }}" + "/" + site_ads_id,
            type: "GET",
            dataType: 'json',
            success: function (data) {
                ...
                if(data.status == "success"){
                    ...
                    $('.site_order').val(data.result.site_order);
                    

                    var image="{{asset('/uploads/siteads')}}" + "/" +data.result.image;
    ...
    $("body").on('click','.site-ads-delete', function(e){
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url:"{{URL::to('easy-hostel/ads/delete')}}" + "/" + site_ads_id,
                    type:"GET",
                    dataType:"Json",
                    data:{_token:"{{csrf_token()}}"},
                    success:function(data){
                        if(data.status == "success")
                        {
                            ...
                            Toast.fire({
                                type: 'success',
                                title: 'Site Ads Deleted successfully'
                            });
                            site_ads_table.ajax.reload();
