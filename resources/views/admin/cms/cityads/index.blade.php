    ...
    <div class="card" style="width: 100%">
        <div class="card-header">
            <h4 class="m-0 font-weight-bold text-primary">
                <a href="javascript:void(0)" type="button" class="btn btn-default btn-sm add-city-ads">add new ads</a>
                City Ads Table
            </h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <div>
                    <table class="stripe" id="tbl_city_ads">
                        ...
                        <form role="form" name="siteadsForm" id="siteadsForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <select name="cityid" class="form-control cityid" required data-msg="Please select cityid"  id="cityid">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="ads_link" class="form-control ads_link" required  data-msg="Social site ads url shouldn't be empty">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
...
@section('js')
    <script type="text/javascript">
        $(document).ready( function () {
            /* datatable */
            var site_ads_table = $('#tbl_city_ads').DataTable({
                dom: 'Bfrtip',
                LengthChange: true,
                "bProcessing": true,
            ...
            $('.add-city-ads').on('click',function(e){
                e.preventDefault();
                save_method = "add";
                $('#cityid').empty();
                $('#cityid').prepend('<option disabled="disabled" selected="selected">Please select city</option>');
                ...
                $('.modal-title').text('City Ads Add Form');
            ...
            $('.saveSiteAds').click(function(e){
                ...
                if($('#siteadsForm').valid()){
                    ...
                    if(save_method == 'add')
                    {
                        uri = "{{route('cityads.store')}}";
                    }
                    else{
                        var site_ads_id  = $(".site-ads-id").val();
                        uri = "{{ URL::to('/easy-hostel/cityads/update') }}" + "/" + site_ads_id;
                    }
                    /* form data */
                        ...
                        success: function (data) {
                            ...
                            if(data.status=='success'){
                                ...
                                if(save_method == 'add'){
                                    ...
                                    Toast.fire({
                                        type: 'success',
                                        title: 'City Ads Added Successfully'
                                    });
                                    ...
                                    Toast.fire({
                                        type: 'success',
                                        title: 'City ADs Updated successfully'
                                    });
                                    site_ads_table.ajax.reload();
            ...
            $("body").on('click','.site-ads-edit', function(e){
                ...
                $.ajax({
                    url:"{{ URL::to('easy-hostel/cityads/edit') }}" + "/" + site_ads_id,
                    type: "GET",
                    dataType: 'json',
                    success: function (data) {
                        ...
                        if(data.status == "success"){
                            ...
                            var image="{{asset('/uploads/cityads')}}" + "/" +data.result.image;
            ...
            $("body").on('click','.site-ads-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url:"{{URL::to('easy-hostel/cityads/delete')}}" + "/" + site_ads_id,
                            type:"GET",
                            dataType:"Json",
                            data:{_token:"{{csrf_token()}}"},
                            success:function(data){
                                if(data.status == "success")
                                {
                                    ...
                                    Toast.fire({
                                        type: 'success',
                                        title: 'City Ads Deleted successfully'
                                    });
                                    site_ads_table.ajax.reload();
