                    ...
                    <form role="form" name="siteadsForm" id="siteadsForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <select name="cityid" class="form-control cityid" required
                                    data-msg="Please select cityid" id="cityid">
...
$(document).ready(function() {
    ...
    $('.add-city-ads').on('click', function(e) {
        ...
        $('#cityid').empty();
        $('#cityid').prepend(
            '<option disabled="disabled" selected="selected">Please select city</option>');
    ...
    $("body").on('click', '.site-ads-delete', function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{URL::to('easy-hostel/cityads/delete')}}" + "/" +
                        site_ads_id,
                    type: "GET",
                    dataType: "Json",
                    data: {
