                        ...
                        <form role="form" name="siteadsForm" id="siteadsForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <select name="placeid" class="form-control placeid" required data-msg="Please select place"  id="placeid">
    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            $('.add-place-ads').on('click',function(e){
                ...
                save_method = "add";
                $('#placeid').empty();
                $('#placeid').prepend('<option disabled="disabled" selected="selected">Please select place</option>');
            ...
            $("body").on('click','.site-ads-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url:"{{URL::to('easy-hostel/placeads/delete')}}" + "/" + site_ads_id,
                            type:"GET",
                            dataType:"Json",
                            data:{_token:"{{csrf_token()}}"},
                            success:function(data){
