        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row register-form">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <a href="{{ route('registerasvendor') }}" class="registerasvendor">Or Register As Hostel Owner</a>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <input type="number" minlength="10" maxlength="10" name="phone" class="form-control @error('phone') is-invalid @enderror"  value="{{ old('phone') }}"  autocomplete="phone" placeholder="Your Phone *"/>
                        @error('phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
