        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="POST" action="{{ route('admin.register.post') }}">
                @csrf
                <div class="form-group mb-3">
                        <div class="input-group input-group-alternative">
                          ...
                          <input class="form-control @error('name') is-invalid @enderror" placeholder="Name" type="name" id="name" name="text" value="{{ old('name') }}" required autocomplete="name" autofocus>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-alternative">
                        ...
                        <input id="password-confirm" class="form-control" name="password_confirmation" required autocomplete="new-password" type="password">
          ...
          <div class="row mt-3">
            <div class="col-12 text-center">
                <a href="{{ route('admin.login') }}" class="text-light"><small>Already Have Account?</small></a>
            </div>
