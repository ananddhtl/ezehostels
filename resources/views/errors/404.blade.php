        ...
        <div class="col-md-6 mx-auto text-center">
            <div class="row">
                ...
                <div class="col-sm-8 text-left">
                    <p style="font-weight: 800; font-size: 120px; color: white; margin:0; line-height: 120px;">404</p>
                    <p style="font-size: 20px; color: white;">Oops! We can't seem to find the page you are looking for.</p>
